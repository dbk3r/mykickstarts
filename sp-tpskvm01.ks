...
network --device=br0 --onboot=yes --bridgeslaves=eth0 --ip=192.168.222.40 --netmask=255.255.255.0 --gateway=192.168.222.1 --nameserver=192.168.169.10 --bootproto=static --hostname=sp-tpskvm01.ad.rbb-online.de
