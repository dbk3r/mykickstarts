...
network --device=br0 --onboot=yes --bridgeslaves=eth0 --ip=192.168.151.55 --netmask=255.255.255.0 --gateway=192.168.151.1 --nameserver=192.168.169.10 --bootproto=static --hostname=sp-tpsdock02.rbb-online.de
